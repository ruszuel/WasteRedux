...
const plasticDecomposition = () => {
  return (
    <SafeAreaView className='flex-1 px-5 gap-y-3' style={{paddingTop: verticalScale(20)}}>
      <View className='mb-5'>
        <Text className='font-pbold text-secondary' style={{fontSize: moderateScale(26)}}>Plastic Decomposition</Text>
        <Text className='font-pregular' style={{fontSize: moderateScale(14)}}>from chariotenergy.com</Text>
      </View>
      <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
        ...
        <Text className='font-pbold text-secondary mb-5' style={{fontSize: moderateScale(26)}}>
        ...
        />
        <Text className='text-justify font-pregular mb-5' style={{fontSize: moderateScale(16)}}>Here are the estimated decomposition timelines for typical plastic waste items:</Text>
        <View className='mb-5'>
            <Image source={require('../../assets/images/articles/plastic-decomposition.jpg')} style={{height: verticalScale(150), width: '100%'}} resizeMode='cover'/>
        </View>
        <Text className='font-pbold text-secondary mb-5' style={{fontSize: moderateScale(26)}}>Plastic is so difficult to degrade</Text>
