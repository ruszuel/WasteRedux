    ...
    <SafeAreaView className='px-5 flex-1 gap-12 bg-fourth' style={{paddingVertical: verticalScale(90)}}>
        ...
        <View style={{gap: 30}}>
            <View className='border border-gray-400 rounded-xl flex-row justify-between items-center'>
                <TextInput className='flex-1 font-pregular' style={{fontSize: moderateScale(13.5), padding: moderateScale(14)}} placeholder='Old Password' cursorColor={'black'} secureTextEntry={visible ? false : true}/>    
