  ...
  return (
    <SafeAreaView className="px-20 flex-1 justify-center gap-10">
        ...
        <View className="gap-y-7">
            ...
            <Text className="font-pregular text-center" style={{fontSize: moderateScale(16)}}>You have successfully registered a solid waste material</Text>
        </View>
        <View className="mt-16">
            <TouchableOpacity className="bg-primary rounded-xl" style={{padding: moderateScale(18)}} onPress={() => router.replace('home')}>
                <Text className="font-pmedium text-center text-white" style={{fontSize: moderateScale(16.5)}}>Go to Home</Text>
            </TouchableOpacity>
        </View>
    </SafeAreaView>
  )
