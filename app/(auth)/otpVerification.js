...
const otpVerification = () => {
  ...
  return (
    <SafeAreaView className='py-32 px-5 flex-1 gap-12 bg-fourth items-center'>
        ...
        <TouchableOpacity className='bg-primary rounded-2xl w-[75%]' style={{padding: moderateScale(15)}} onPress={() => router.push('ResetPass')}>
            <Text className='text-center text-white font-pmedium' style={{fontSize: moderateScale(14)}}>Verify</Text>
        </TouchableOpacity>
        <Link href={'/LogIn'} className='text-center font-pregular' style={{fontSize: moderateScale(11.5)}}>Didn't receive a code? <Text className='text-blue-400'>Resend</Text></Link>
