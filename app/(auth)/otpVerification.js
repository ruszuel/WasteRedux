...
const otpVerification = () => {
  ...
  return (
    <SafeAreaView className='py-32 px-5 flex-1 gap-12 bg-fourth items-center'>
        ...
        <Link href={'/LogIn'} className='text-center font-pmedium' style={{fontSize: moderateScale(13)}}>Didn't receive a code? <Text className='text-blue-400'>Resend</Text></Link>
