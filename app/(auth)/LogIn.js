import { View, Text, SafeAreaView, TextInput, TouchableOpacity, Dimensions, PixelRatio, Pressable } from 'react-native'
...
const LogIn = () => {
  ...
  return (
    <SafeAreaView className="flex-1 px-5 justify-center" style={{paddingVertical: width * 0.16}}>
        ...
        <View className="py-10" style={{gap: 20}}>
            ...
            <View style={{gap: 25}}>
                <View className="justify-center">
                    <TextInput className="rounded-xl border border-gray-400 font-pregular" style={{fontSize: moderateScale(13.5), padding: moderateScale(14)}} placeholder='Email address' keyboardType='default'/>    
                </View>
            ...
            <View className="flex-row justify-between items-end" style={{paddingTop: width * 0.04}}>
                <Pressable className="flex-row items-start gap-2">
                 <Checkbox value={isChecked} onValueChange={setChecked} color={'#81A969'} style={{width: scale(12), height: verticalScale(11)}}/>
        ...
        <View>
            {/* Buttons */}
            <TouchableOpacity className="bg-primary rounded-2xl" style={{padding: moderateScale(15)}} onPress={() => router.push("Onboard")}>
